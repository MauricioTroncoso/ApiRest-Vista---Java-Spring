 ...
 * @author Vermi
 */
public class servleteditdistribuidores extends HttpServlet {
    ...
    protected void doPost (HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            try{
                ...
                WebTarget target = client.target("http://localhost:8090/api/distribuidor/"+ request.getParameter("id"));

                distribuidores dis = new distribuidores();
                dis.setNombre(request.getParameter("nombre_distribuidor"));
                Gson gson= new Gson();
